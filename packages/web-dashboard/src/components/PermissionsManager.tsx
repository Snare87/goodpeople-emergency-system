...
const PermissionsManager: React.FC<PermissionsManagerProps> = ({ 
  ...
  const [appPermission, setAppPermission] = useState<boolean>(permissions?.app || false);
  const [webPermission, setWebPermission] = useState<boolean>(permissions?.web || false);
